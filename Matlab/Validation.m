...
mdot = table2array(hpdata(181:3540,26));  % mdot [kg/s]
...
T_in_h = nan(840,1);T_out_h = nan(840,1);
mdot_h = nan(840,1); COP_meas_h = nan(840,1);
for i = 1:840
...
mdot_h =  mdot_h./4; COP_meas_h = COP_meas_h./4;
...
for i = 1:N
    ...
    P_forecast_a(i) = (C_w*rho_w*pred_all(i,1)*(T_s_h(i+672)-T_r_h(i+672))-...
                      ...
                      C_b*mdot_h(i+672)*(T_out_h(i+672)-T_in_h(i+672)));
